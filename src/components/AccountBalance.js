...
import { Col, Button, Tabs, Tab, Table, Row, Container } from "react-bootstrap";
  ...
  return (
    ...
    <Row>
      <Col xs={12} lg={3}>
        ...
        <p className="mb-0">Limite disponí­vel</p>
        <p className="mb-4">R$ 5.000,00</p>
        <Button variant="secondary">Ver extrato</Button>
      </Col>
      <Col xs={12} lg={9}>
        <Tabs className= "mt-sm pt-sm-5 mt-lg-0 pt-lg-0" defaultActiveKey="latest">
